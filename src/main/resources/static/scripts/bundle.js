...
/******/ ([
    ...
    /***/ (function(module, exports, __webpack_require__) {
        ...
        function TodoLogoutConstructor() {

            this._logOutNode = document.querySelector('.js-todo-Bottom-logout-button');
            this._logOutNode.addEventListener('click', this)
        }

        var TodoLogoutConstructorPrototype = TodoLogoutConstructor.prototype;


        TodoLogoutConstructorPrototype._logOut = function () {
            logOut()
            return this;
        };

        TodoLogoutConstructorPrototype.handleEvent = function (e) {
            switch (e.type) {
                case 'click':
                    this._logOut();
                    break;
        ...
        function init() {
            ...
            var todoLogout = new TodoLogoutConstructor();
                ...
                if (xmlHttp.readyState === XMLHttpRequest.DONE && xmlHttp.status === 200){
                    if(xmlHttp.responseText !== "[]"){
                        for(let i = 0; i < JSON.parse(xmlHttp.responseText).length; i++){
                            todoList.createItemAll(JSON.parse(xmlHttp.responseText)[i]);
                        }
                    }
                }
            };
    ...
    /***/ (function(module, exports, __webpack_require__) {
        ...
        todoListConstructorPrototype.createItemAll = function (todoItemData) {
            var item = new TodoItem(Object.assign(
                {
                    id: todoItemData.itemId,
                    text : todoItemData.text,
                    isReady : todoItemData.isReady,
                }
            ));

            if (todoItemData.itemId >= itemsIdIterator) {
                itemsIdIterator = todoItemData.itemId + 1;
            }
            item._markReady.checked = todoItemData.isReady;
            item.on('change', this._onItemChange, this)
                .on('remove', this._onItemRemove, this)
                .render(this._todosList);
        ...
        todoListConstructorPrototype._onItemRemove = function (itemId) {
            ...
            let userId = getCookie("userId");
            var items = {
                itemId : todoItemComponent.model.id,
                text : todoItemComponent.model.text,
                userId : userId,
                isReady : todoItemComponent.model.isReady
            };
    ...
    /***/ (function(module, exports, __webpack_require__) {
        ...
        /*todoActionsBarConstructorPrototype._logOut = function () {
            this.trigger('logOut');
            return this;
        };*/
    ...
    /***/ (function(module, exports, __webpack_require__) {
        ...
        extendConstructor(TodoLogoutConstructor, Eventable);
        ...
        module.exports = TodoLogoutConstructorPrototype;
